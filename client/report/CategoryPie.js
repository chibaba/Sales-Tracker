...
import {averageCategories} from './../sales/api-sales.js'
    ...
    return (
      <div>
            <div className={classes.search}>
                <Typography variant="h6" className={classes.title}>Sales per category </Typography>
        ...
        <Button variant="contained" color="secondary" onClick={searchClicked}>GO</Button>
            ...
            <VictoryPie standalone={false} data={sales.monthAVG} innerRadius={50} theme={VictoryTheme.material} 
